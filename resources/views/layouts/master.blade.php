...
{{--                                         @foreach ($menus as $menu )
                                                    <li class="mainmenu__item">
                                                        <a href="/" class="mainmenu__link">
                                                            <span data-hover="Home" class="mm-text">{{$menu->caption}}</span>
                                                        </a>
                                                    </li> --}}
                                                    @foreach ($menus as $menu )
                                            ...
                                            <div class="site-info--wrapper d-none d-lg-block">
                                                <div class="site-info">
                                                    <div class="site-info__item">
                                                        <a href="tel:{{ $global_setting->phone }}"><strong>{{ $global_setting->phone }}</strong></a>, <a href="tel:{{ $global_setting->nepali_phone }}"><strong>{{ $global_setting->phone_ne }}</strong></a>
                            ...
                            <div class="footer-widget">
                                ...
                                <div class="footer-widget">
                                    <ul class="footer-menu">
                                        ...
                                        <li><a href="tel:014418667">{{ $global_setting->phone }}</a>, <a href="tel:014430423">{{ $global_setting->phone_ne }}</a></li>
                                        <li><a href="mailto:{{ $global_setting->site_email }}">{{ $global_setting->site_email }}</a>, <a href="mailto:{{ $global_setting->page_description }}">{{ $global_setting->page_description }}</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-12 text-center">
                            <p class="copyright-text">&copy;
                                ...
                                SRS Overseas Pvt. Ltd. All Rights Reserved. Developed by <a href="http://radiantnepal.com/" target="_blank">Radiant Infotech Nepal</a>
                            </p>
                        </div>
                    </div>
                </div>
